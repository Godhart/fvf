#!/bin/python
h = """
Runs hardcoded tests for calc app.
Test environment for this demo contains mocked object so no real app and
no other test environment's objects are required to run this demo.
