#!/bin/python
h = """
Preforms constrained random testing of calc app (located in /src/comealong/calc)

This one uses test from module 'main', not 'crt' like demo '05-calc_crt.py', 
but it specifies special arg to use crt test set.
